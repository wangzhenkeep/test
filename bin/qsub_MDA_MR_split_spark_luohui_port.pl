...
while (<IN>) {
	...
	print SH "perl $binpath/../High_PPI/MDA/MDA_pipeline_600k_split_spark_luohui_port.pl $temp[0] $binpath/../Database/hg19.fasta $linshi_path/$temp $temp[2]\n";
	...
	print SH "rm $linshi_path/$temp/*.bam $linshi_path/$temp/*.bam.bai\n";
