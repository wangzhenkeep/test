...
#runcmd ("MIB prepare", "/share/data/liyang/MIB_SNAP/MIB.sh -z -i all.fastq");
#runcmd ("MIB", "env LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/share/biosoft/glibc-2.14/lib LC_ALL=C  /share/data/liyang/MIB_SNAP/MIB.sh  -c all.fastq.conf -i all.fastq");
